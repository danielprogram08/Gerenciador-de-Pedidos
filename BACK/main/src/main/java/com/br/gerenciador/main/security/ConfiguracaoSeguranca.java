	...
	public SecurityFilterChain CorrenteFiltroSeguranca(HttpSecurity httpSecurity) throws Exception {
		return httpSecurity
				...
				.authorizeHttpRequests(authorize -> authorize
						...
						.requestMatchers(HttpMethod.POST, "/pedidos/cadastrar").hasRole("ADMIN")
						.requestMatchers(HttpMethod.GET, "/pedidos/listar").hasRole("ADMIN")
						.requestMatchers(HttpMethod.GET, "/pedidos/projection").hasRole("ADMIN")
						.requestMatchers(HttpMethod.POST, "/pedidos/atualizar").hasRole("ADMIN")
						.requestMatchers(HttpMethod.DELETE, "/pedidos/excluir").hasRole("ADMIN")
